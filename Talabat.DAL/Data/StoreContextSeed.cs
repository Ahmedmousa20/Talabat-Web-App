...
namespace Talabat.DAL.Data
{
    public class StoreContextSeed
    {
        public static async Task SeedAsync(StoreContext context , ILoggerFactory loggerFactory)
        {
            ...
            {
                #region Comments
                //if (!context.ProductBrands.Any()) --غير مره واحد بس مع بدايه البرنامج  seed دى انا عاملها عشان ميعملش 
                //والداتا بيز فاضيه لكن لو الداتا بيز فيها داتا مش هعمل حاجه 
                #endregion
